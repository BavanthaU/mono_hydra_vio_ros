...
The infrared cameras offer the option to run the [mono_hydra_vio](https://github.com/BavanthaU/mono_hydra_vio) stereo version on monochrome global shutter cameras, which are generally better suited for visual tracking.
